...
# Form implementation generated from reading ui file 'tcs3.ui'
#
...
class Ui_TCS(object):
    def setupUi(self, TCS):
        ...
        self.gb_heaters.setGeometry(QtCore.QRect(10, 560, 701, 221))
	...
	self.cb_lp10_top = QtWidgets.QCheckBox(self.gb_diodetop)
        ...
        self.graphWidget.setGeometry(QtCore.QRect(10, 70, 521, 480))
        self.graphWidget.setObjectName("graphWidget")
        self.ln_sensor = QtWidgets.QLineEdit(self.gb_graph)
        self.ln_sensor.setGeometry(QtCore.QRect(120, 30, 75, 20))
        self.ln_sensor.setObjectName("ln_sensor")
        self.ln_to = QtWidgets.QLineEdit(self.gb_graph)
        self.ln_to.setGeometry(QtCore.QRect(200, 30, 75, 20))
        self.ln_to.setObjectName("ln_to")
        self.ln_tf = QtWidgets.QLineEdit(self.gb_graph)
        self.ln_tf.setGeometry(QtCore.QRect(280, 30, 75, 20))
        self.ln_tf.setObjectName("ln_tf")
        self.pb_graph = QtWidgets.QPushButton(self.gb_graph)
        self.pb_graph.setGeometry(QtCore.QRect(360, 30, 40, 20))
        self.pb_graph.setObjectName("pb_graph")
        self.lb_graph = QtWidgets.QLabel(self.gb_graph)
        self.lb_graph.setGeometry(QtCore.QRect(120, 20, 75, 10))
        self.lb_graph.setAlignment(QtCore.Qt.AlignCenter)
        self.lb_graph.setObjectName("lb_graph")
        self.lb_graph_2 = QtWidgets.QLabel(self.gb_graph)
        self.lb_graph_2.setGeometry(QtCore.QRect(200, 20, 75, 10))
        self.lb_graph_2.setAlignment(QtCore.Qt.AlignCenter)
        self.lb_graph_2.setObjectName("lb_graph_2")
        self.lb_graph_3 = QtWidgets.QLabel(self.gb_graph)
        self.lb_graph_3.setGeometry(QtCore.QRect(280, 20, 75, 10))
        self.lb_graph_3.setAlignment(QtCore.Qt.AlignCenter)
        self.lb_graph_3.setObjectName("lb_graph_3")
        self.gb_cal = QtWidgets.QGroupBox(self.centralWidget)
        self.gb_cal.setGeometry(QtCore.QRect(10, 450, 151, 71))
        self.gb_cal.setObjectName("gb_cal")
        self.pb_p = QtWidgets.QPushButton(self.gb_cal)
        self.pb_p.setGeometry(QtCore.QRect(30, 30, 90, 25))
        self.pb_p.setObjectName("pb_p")
        self.lb_UTC = QtWidgets.QLabel(self.centralWidget)
        self.lb_UTC.setGeometry(QtCore.QRect(30, 780, 150, 20))
        self.lb_UTC.setObjectName("lb_UTC")
        self.timer = QtWidgets.QLabel(self.centralWidget)
        self.timer.setGeometry(QtCore.QRect(620, 780, 150, 20))
    ...
    def retranslateUi(self, TCS):
        ...
        self.pb_h1.setText(_translate("TCS", "13"))
        self.lb_h1.setText(_translate("TCS", "--%"))
        self.pb_h2.setText(_translate("TCS", "14"))
        self.lb_h2.setText(_translate("TCS", "--%"))
        self.pb_h3.setText(_translate("TCS", "15"))
        self.lb_h3.setText(_translate("TCS", "--%"))
        self.pb_h4.setText(_translate("TCS", "16"))
        self.lb_h4.setText(_translate("TCS", "--%"))
        self.lb_h8.setText(_translate("TCS", "--%"))
        self.pb_h5.setText(_translate("TCS", "17"))
        self.lb_h5.setText(_translate("TCS", "--%"))
        self.lb_h7.setText(_translate("TCS", "--%"))
        self.pb_h7.setText(_translate("TCS", "19"))
        self.pb_h8.setText(_translate("TCS", "20"))
        self.lb_h6.setText(_translate("TCS", "--%"))
        self.pb_h6.setText(_translate("TCS", "18"))
        self.lb_h12.setText(_translate("TCS", "--%"))
        self.lb_h9.setText(_translate("TCS", "--%"))
        self.pb_h11.setText(_translate("TCS", "23"))
        self.lb_h10.setText(_translate("TCS", "--%"))
        self.pb_h10.setText(_translate("TCS", "22"))
        self.pb_h12.setText(_translate("TCS", "24"))
        self.lb_h11.setText(_translate("TCS", "--%"))
        self.pb_h9.setText(_translate("TCS", "21"))
        self.lb_h16.setText(_translate("TCS", "--%"))
        self.lb_h13.setText(_translate("TCS", "--%"))
        self.pb_h15.setText(_translate("TCS", "27"))
        self.lb_h14.setText(_translate("TCS", "--%"))
        self.pb_h14.setText(_translate("TCS", "26"))
        self.pb_h16.setText(_translate("TCS", "28"))
        self.lb_h15.setText(_translate("TCS", "--%"))
        self.pb_h13.setText(_translate("TCS", "25"))
        ...
        self.lb_h1_top.setText(_translate("TCS", "--%"))
        ...
        self.cb_lp10_top.setText(_translate("TCS", "TD10: --- C"))
        self.cb_lp14_top.setText(_translate("TCS", "TD14: --- C"))
        self.cb_lp2_top.setText(_translate("TCS", "TR2: --- C"))
        self.cb_lp6_top.setText(_translate("TCS", "TR6: --- C"))
        self.cb_lp12_top.setText(_translate("TCS", "TD12: --- C"))
        self.cb_lp8_top.setText(_translate("TCS", "TD8: --- C"))
        self.cb_lp4_top.setText(_translate("TCS", "TR4: --- C"))
        self.cb_lp16_top.setText(_translate("TCS", "TR16: --- C"))
        self.cb_lp18_top.setText(_translate("TCS", "TR18: --- C"))
        self.gb_diodetop.setTitle(_translate("TCS", "Diodes"))
        self.cb_lp20_top.setText(_translate("TCS", "TR20: --- C"))
        self.cb_lp21_top_2.setText(_translate("TCS", "TD21: --- C"))
        self.cb_lp13_top.setText(_translate("TCS", "TR13: --- C"))
        self.cb_lp1_top.setText(_translate("TCS", "TD1: --- C"))
        self.cb_lp11_top.setText(_translate("TCS", "TR11: --- C"))
        self.cb_lp9_top.setText(_translate("TCS", "TR9: --- C"))
        self.cb_lp7_top.setText(_translate("TCS", "TD7: --- C"))
        self.cb_lp17_top.setText(_translate("TCS", "TD17: --- C"))
        self.cb_lp5_top.setText(_translate("TCS", "TD5: --- C"))
        self.cb_lp19_top.setText(_translate("TCS", "TD19: --- C"))
        self.cb_lp15_top.setText(_translate("TCS", "TD15: --- C"))
        self.cb_lp3_top.setText(_translate("TCS", "TD3: --- C"))
        self.gb_lpsensorsbtm.setTitle(_translate("TCS", "LP Sensors - Bottom"))
        self.gb_resistersbtm.setTitle(_translate("TCS", "Resistors"))
        self.cb_lp10_btm.setText(_translate("TCS", "BD34: --- C"))
        self.cb_lp8_btm.setText(_translate("TCS", "BR32: --- C"))
        self.cb_lp18_btm.setText(_translate("TCS", "BR42: --- C"))
        self.cb_lp14_btm.setText(_translate("TCS", "BD38: --- C"))
        self.cb_lp2_btm.setText(_translate("TCS", "BR23: --- C"))
        self.cb_lp12_btm.setText(_translate("TCS", "BD36: --- C"))
        self.cb_lp4_btm.setText(_translate("TCS", "BR25: --- C"))
        self.cb_lp6_btm.setText(_translate("TCS", "BR30: --- C"))
        self.cb_lp16_btm.setText(_translate("TCS", "BD40: --- C"))
        self.cb_lp28_btm.setText(_translate("TCS", "BR52: --- C"))
        self.cb_lp20_btm.setText(_translate("TCS", "BR44: --- C"))
        self.cb_lp24_btm.setText(_translate("TCS", "BR48: --- C"))
        self.cb_lp30_btm.setText(_translate("TCS", "BD54: --- C"))
        self.cb_lp26_btm.setText(_translate("TCS", "BR50: --- C"))
        self.cb_lp22_btm.setText(_translate("TCS", "BR46: --- C"))
        self.gb_diodebtm.setTitle(_translate("TCS", "Diodes"))
        self.cb_lp9_btm.setText(_translate("TCS", "BD33: --- C"))
        self.cb_lp13_btm.setText(_translate("TCS", "BR37: --- C"))
        self.cb_lp1_btm.setText(_translate("TCS", "BD22: --- C"))
        self.cb_lp5_btm.setText(_translate("TCS", "BD26: --- C"))
        self.cb_lp21_btm.setText(_translate("TCS", "BD45: --- C"))
        self.cb_lp11_btm.setText(_translate("TCS", "BR35: --- C"))
        self.cb_lp23_btm.setText(_translate("TCS", "BD47: --- C"))
        self.cb_lp19_btm.setText(_translate("TCS", "BD43: --- C"))
        self.cb_lp7_btm.setText(_translate("TCS", "BD31: --- C"))
        self.cb_lp29_btm.setText(_translate("TCS", "BR53: --- C"))
        self.cb_lp27_btm.setText(_translate("TCS", "BD51: --- C"))
        self.cb_lp3_btm.setText(_translate("TCS", "BD24: --- C"))
        self.cb_lp15_btm.setText(_translate("TCS", "BR39: --- C"))
        self.cb_lp25_btm.setText(_translate("TCS", "BD49: --- C"))
        self.cb_lp17_btm.setText(_translate("TCS", "BD41: --- C"))
        self.cb_lp31_btm.setText(_translate("TCS", "BR55: --- C"))
        self.gb_graph.setTitle(_translate("TCS", "Graph"))
        self.pb_graph.setText(_translate("TCS", "graph"))
        self.lb_graph.setText(_translate("TCS", "Sensors"))
        self.lb_graph_2.setText(_translate("TCS", "Initial Time"))
        self.lb_graph_3.setText(_translate("TCS", "Final Time"))
        self.gb_cal.setTitle(_translate("TCS", "Calibration"))
        self.pb_p.setText(_translate("TCS", "Open pid.conf"))
        self.lb_UTC.setText(_translate("TCS", "UTC: -----"))
        self.timer.setText(_translate("TCS", "20/60 sec (33%)"))
